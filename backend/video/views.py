...
from video.serializers import VideoCategorySerializer,VideoSerializer,PlaylistSerializer   ,VideoPatchSerializer,PlaylistVideoAddSerializer
...
class VideoViewSet(BaseAuthModelViewSet):
    ...
    def partial_update(self, request, *args, **kwargs):
        ...
        if video.user_id == user_id:
            ...
            return Response({"detail":"You are not allowed to upate the video details"}) 
